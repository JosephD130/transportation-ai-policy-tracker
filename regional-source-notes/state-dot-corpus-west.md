...
| 6 | **Idaho — ITD** | No DOT-specific; statewide guidance in draft | [ITS AI Help Center](https://its.idaho.gov/ai/) | 2025 (draft to legislature) | **SILENT** | Office of Information Technology Services (ITS) is drafting statewide AI guidance; presented to legislature Jul 2025 | No AI EO; legislature work-group reviewing | ITD piloting GenAI w/ small group of employees; ITD presented "GenAI Challenge to Highway QA Integrity" at TRB; ITD DMV named one of four AI leaders by ITS |
...
- **ENCOURAGE-with-guardrails (7):** Arizona, California, Nevada, Oregon, Utah, Washington — plus Alaska, where two 2025 administrative orders are explicitly pro-AI but lack data-handling fences.
- **SILENT at DOT level (6):** Colorado, Hawaii (framework still being built), Idaho (draft pending), Montana, New Mexico (transparency-only), Wyoming.
- **FORBID (0):** No western state DOT operates under an explicit prohibition on cloud AI uploads. The strictest language is Arizona's P2000 ("confidential data shall not be entered into publicly accessible AI systems without authorization"), and Nevada's policy floor ("agency-level AI policies cannot be more lenient than statewide").
